...
#	--git-repo="https://github.com/motivast/polylang-string-extractor" \
#	--svn-user=user
#	--after-git-checkout="composer install --no-dev --no-scripts"
#
# DESCRIPTION: Sync github Polylang String Extractor repository with wordpress.org svn repository
#
#===================================================================================
